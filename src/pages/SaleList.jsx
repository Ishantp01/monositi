...
const saleData = [
    ...
    {
        image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?q=80&w=1200",
        ...
        <>
            ...
            <div className="max-w-6xl mx-auto p-4 space-y-8 font-inter">
                {saleData.map((item, index) => (
                    <>
                        <SaleCard key={index} {...item} />
                        {index == 5 ?
                            <div className="bg-red-200 rounded-lg flex justify-between items-center h-28 px-8">
                                <h1 className="md:text-3xl font-mono">Post Your Property For Free Here</h1>
                                <button
