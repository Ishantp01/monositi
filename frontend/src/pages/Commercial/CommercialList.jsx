...
import CommercialCard from "../../components/Commercial/components/CommercialCarousel";
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="container mx-auto max-w-7xl px-4 lg:px-6 py-8 space-y-8 font-inter">
          {/* Dynamic Filter Bar for Commercial */}
          <DynamicFilterBar activeTab="Commercial" />
