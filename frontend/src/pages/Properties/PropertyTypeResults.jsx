        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 space-y-4">
            ...
            <p className="text-gray-600 text-center max-w-md">
              There are currently no {type.toLowerCase()} properties waiting for
              review.
            </p>
          </div>
        ) : (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-gray-200">
                      <button
                        onClick={async () => {
                          try {
                            const res = await propertyApi.verifyProperty(
                              p._id,
                              "Verified"
                            ); // ✅ pass status here
                            if (res.success) {
                ...
                {propertyDetails.genderPreference && (
                  <div className="space-y-3">
                    ...
                    <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-50 text-purple-700 border border-purple-200">
                      {propertyDetails.genderPreference === "Boys" &&
                        "👦 Boys Only"}
                      {propertyDetails.genderPreference === "Girls" &&
                        "👧 Girls Only"}
                      {propertyDetails.genderPreference === "Co-ed" &&
                        "👥 Co-ed"}
                      {propertyDetails.genderPreference === "Any" &&
                        "✅ Any Gender"}
                    </div>
                  </div>
                )}
