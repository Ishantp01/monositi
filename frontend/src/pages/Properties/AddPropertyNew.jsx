                        ...
                        <form onSubmit={handleSubmit} className="p-6">
                                        ...
                                        <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span className="text-sm text-green-700">
                                                    Location captured: {formData.geo_location?.coordinates[1]?.toFixed(6)}, {formData.geo_location?.coordinates[0]?.toFixed(6)}
                                                </span>
                                            </div>
                                        </div>
                                    )}
                            ...
                            {activeTab === "media" && (
                                ...
                                >
                                    ...
                                    {/* Photo Upload */}
                                    <div className="space-y-4">
                                        <h4 className="font-medium text-gray-700">Property Photos (Max 8)</h4>
                                    ...
                                    {/* Document Upload */}
                                    <div className="space-y-4">
                                        <h4 className="font-medium text-gray-700">Property Documents (Max 6)</h4>
                                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                            <FileText className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                                            <p className="text-gray-600 mb-4">Upload property documents</p>
                                            <input
                                                type="file"
                                                multiple
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">Your property will be reviewed before going live</p>
                                    </div>
                                    <button
                                        type="submit"
                                        disabled={loading}
