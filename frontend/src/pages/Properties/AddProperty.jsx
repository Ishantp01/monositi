    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-6">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {message && (
            <div
              className={`max-w-2xl mx-auto p-6 rounded-xl shadow-lg border-2 ${
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          Up to 5 high-quality images (JPEG, PNG)
                        </p>
                      </div>
                      <input
                        type="file"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h4 className="font-semibold text-gray-700">
                          Uploaded Photos ({photoPreviews.length}/5)
                        </h4>
                        <button
                          type="button"
                          onClick={() => {
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-600">
                    Review your information and submit your property listing.
                    We'll review it before making it live.
                  </p>
                </div>
