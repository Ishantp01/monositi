...
const CreateService = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.service_docs.length === 0) {
        toast.error("Please upload at least one service document/certificate");
        setLoading(false);
        setActiveTab("media");
        return;
      }
      ...
      if (result.success) {
        toast.success(
          "Service created successfully! It will be reviewed by admin."
        );
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-white/90 text-sm md:text-base">
                    Join our service provider network and showcase your skills
                    to customers
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-green-700">
                              Location captured successfully! Address will be
                              auto-filled.
                            </span>
                          </div>
                        </div>
                      ...
                      <input
                        ...
                        value={(() => {
                          try {
                            if (
                              formData.location &&
                              formData.location.includes("coordinates")
                            ) {
                              const locationObj = JSON.parse(formData.location);
                              return (
                                locationObj.address ||
                                `Coordinates: ${locationObj.coordinates[1].toFixed(
                                  6
                                )}, ${locationObj.coordinates[0].toFixed(6)}`
                              );
                            }
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Enter your service area or click "Use My Location" to
                        capture coordinates
                      </p>
                    </div>
                  </div>
              ...
              {activeTab === "pricing" && (
                ...
                >
                  ...
                  {/* Navigation Buttons for Pricing Tab */}
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#f73c56] transition-colors">
                      ...
                      <label htmlFor="documents" className="cursor-pointer">
                        ...
                        <p className="text-gray-600">
                          Click to upload certificates/documents
                        </p>
                        <p className="text-sm text-gray-500 mt-1">
                          PDF, DOC, JPG up to 5MB each
                        </p>
                      </label>
                    </div>
