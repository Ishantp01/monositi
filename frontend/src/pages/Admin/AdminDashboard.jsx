...
const AdminDashboard = () => {
  ...
  const handleSwitchToServiceProvider = async (userId) => {
    if (
      !window.confirm(
        "Are you sure you want to switch this user to service provider?"
      )
    )
      return;
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-white/90 text-sm md:text-base">
                    Manage properties, users, analytics, and reports across the
                    platform
                  </p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                      ...
                      <div className="space-y-3">
                        {dashboardData.recentActivities?.requests
                          ?.slice(0, 5)
                          .map((request) => (
                            <div
                              key={request._id}
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-6">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-600">
                                <span>
                                  Owner: {property.owner_id?.name || "Unknown"}
                                </span>
                                <span>•</span>
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-600">
                                ...
                                <span>
                                  Joined:{" "}
                                  {new Date(
                                    user.createdAt || user.registered_on
                                  ).toLocaleDateString()}
                                </span>
                                {user.rating > 0 && (
                                  <>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {user.verification_status === "pending" && (
                                <>
                                  <button
                                    onClick={() =>
                                      handleVerifyUser(user._id, "verified")
                                    }
                                    className="flex items-center space-x-1 px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm"
                                  >
                                    <CheckCircle className="w-4 h-4" />
                                  ...
                                  <button
                                    onClick={() =>
                                      handleVerifyUser(user._id, "rejected")
                                    }
                                    className="flex items-center space-x-1 px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors text-sm"
                                  >
                                    <XCircle className="w-4 h-4" />
                              ...
                              {user.role === "tenant" && (
                                <button
                                  onClick={() =>
                                    handleSwitchToServiceProvider(user._id)
                                  }
                                  className="flex items-center space-x-1 px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
                                >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {analytics.siteStats?.totalViews?.toLocaleString() ||
                              "0"}
                          </p>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {analytics.siteStats?.uniqueVisitors?.toLocaleString() ||
                              "0"}
                          </p>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {analytics.siteStats?.bounceRate || "0"}%
                          </p>
                        </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {analytics.siteStats?.avgSessionTime || "0:00"}
                          </p>
                        </div>
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-6">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-600">
                                ...
                                <span>•</span>
                                <span>
                                  Rating: {service.ratings?.average || 0}/5
                                </span>
                                <span>•</span>
                                <span>
                                  Created:{" "}
