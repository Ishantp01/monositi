      ...
      <div className="min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600 text-lg">Manage your assigned service requests</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            <div className="bg-gray-50 p-4 border-b border-gray-200">
              ...
              <p className="text-gray-600 mt-1 text-sm">View and manage your assigned requests</p>
            </div>
            ...
            <div className="p-4">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-700">No service requests assigned</h3>
                  <p className="text-gray-500 text-center max-w-md">
                    You don't have any service requests assigned to you yet. New requests will appear here when assigned.
                  </p>
                </div>
              ) : (
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="flex items-center space-x-3">
                            <div className="text-2xl">
                              {req.category?.toLowerCase().includes('plumb') ? '🔧' :
                               ...
                               req.category?.toLowerCase().includes('repair') ? '🔨' : '🛠️'}
                            </div>
                            <div>
                        ...
                        {req.photosBefore?.length > 0 && (
                          <div className="space-y-2">
                            <p className="text-xs font-semibold text-gray-700">Before Photos:</p>
                        ...
                        {req.photosAfter?.length > 0 && (
                          <div className="space-y-2">
                            <p className="text-xs font-semibold text-gray-700">After Photos:</p>
                            <div className="grid grid-cols-2 gap-2">
