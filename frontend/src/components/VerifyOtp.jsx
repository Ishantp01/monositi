      ...
      <div className="rounded-xl border border-gray-300 shadow-sm overflow-hidden">
        <div className="p-6 sm:p-8">
          ...
          <p className="mt-4 text-sm text-gray-600">
            You'll receive a 4-digit verification code on XXXXXXXXXX , if you are
            registered with us
          </p>
          ...
          <p className="mt-2 text-xs text-gray-400">
            You will receive OTP within <span className="text-theme-primary">2:00 min</span>
          </p>
          ...
          <div className="mt-4 text-sm text-gray-600">
            ...
            |{" "}
            <button className="text-blue-600 hover:underline">Verify on Call</button>
            </div>
          </div>
        </div>
      </div>
