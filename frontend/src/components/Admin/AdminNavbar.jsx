...
const AdminNavbar = () => {
  const navItems = [
    ...
    { name: "monositi", path: "/properties/type/Commercial" },
  ...
  return (
    <header className="w-full shadow-sm bg-white border-b">
      <nav
        className={`w-full select-none  flex items-center justify-between px-4 lg:px-12 py-3 relative`}
      >
        <div className="flex items-center space-x-2 md:absolute md:left-1/2 md:transform md:-translate-x-1/2 cursor-default">
          ...
          <h1 className="text-black text-base lg:text-xl font-inter font-extrabold">
            BUILD
          </h1>
        </div>
