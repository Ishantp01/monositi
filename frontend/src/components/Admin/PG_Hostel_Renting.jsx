...
const data = {
  ...
  pending: [
    ...
    {
      id: 4,
      title: "Shreasdfdsafdsadfe Sai PG ,Rajeev Gandhi Chouk, Jabalpur",
      agent: "Rajeev Shingh",
      uploadedOn: "2nd July 2025",
    },
  ],
  rejected: [
    ...
    {
      id: 3,
      title: "Shree adsfadsfSai PG ,Rajeev Gandhi Chouk, Jabalpur",
      agent: "Rajeev Shingh",
      uploadedOn: "22nd July 2025",
    },
    {
...
export default PG_Hostel_Renting;
