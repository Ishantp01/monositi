...
const data = {
  accepted: [
    {
      id: 1,
      title: "Shrladslkljkdsa;lkjfdsalfdsafsajfsda;lkjee Sai PG ,Rajeev Gandhi Chouk, Jabalpur",
      agent: "Rajeev Singh",
...
const Selling_Properties_Residental = () => {
...
export default Selling_Properties_Residental;
