...
export const properties = [
  {
    ...
    description: "Spacious 2BHK apartment with modern amenities, located in the heart of IT Park. Perfect for young professionals.",
  ...
  },
  {
    ...
    description: "Premium 3BHK villa with garden view, modern kitchen, and premium location in Viman Nagar.",
  ...
  },
  {
    ...
    description: "Exclusive 4BHK penthouse with panoramic city view, premium finishes, and luxury amenities.",
    amenities: ["Terrace", "Parking", "Security", "Gym", "Swimming Pool", "Club House"],
    owner: "Amit Singh",
  ...
  },
  {
    ...
    description: "Compact and well-designed 1BHK studio perfect for singles or couples, located in tech hub Koramangala.",
  ...
  },
  {
    ...
    description: "Fully furnished executive studio with all modern amenities, ideal for working professionals.",
  ...
  },
  {
    ...
    description: "Stunning 3BHK apartment with sea view, premium location in Bandra West, Mumbai.",
    amenities: ["Sea View", "Parking", "Security", "Gym", "Swimming Pool", "Club House"],
    owner: "Rohit Mehta",
