...
export const properties = [
    {
        ...
        description: "Prime location residential plot with excellent connectivity and future development potential.",
        amenities: ["Road Access", "Water Supply", "Electricity Connection", "Security"],
        owner: "Vikram Patel",
    ...
    },
    {
        ...
        description: "Well-designed 3BHK apartment with modern amenities, close to railway station for easy commute.",
    ...
    },
    {
        ...
        description: "Spacious 4BHK villa with private garden, premium finishes, and luxury amenities in Noida.",
        amenities: ["Private Garden", "Parking", "Security", "Gym", "Swimming Pool", "Club House"],
        owner: "Ravi Khanna",
    ...
    },
    {
        ...
        description: "Modern office space in prime business district with excellent connectivity and professional environment.",
    ...
    },
    {
        ...
        description: "Efficiently designed studio apartment perfect for working professionals in Gurgaon's business hub.",
    ...
    },
    {
        ...
        description: "Exclusive penthouse with panoramic sea view, premium location in Mumbai's most prestigious area.",
        amenities: ["Sea View", "Terrace", "Parking", "Security", "Gym", "Swimming Pool", "Club House"],
